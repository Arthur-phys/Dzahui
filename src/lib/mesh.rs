...
impl Mesh {
    ...
    pub fn new(mut file: File, dim: Dimension) -> Mesh {
        ...
        let (vertices, triangles, max_length,mid_point) = Mesh::generate_coordinates(&file, ignored_coordinate);
    ...
    fn generate_coordinates(file: &File, ignored_coordinate: Option<usize>) -> (Vec<f64>,Vec<u32>,f64,[f64;3]) {
        // Initial variables
